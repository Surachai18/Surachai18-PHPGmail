...
<body>
  <form class="center_absolute display_grid" action="email.php" method="post">
    ...
    <button class="primary-button background_color_red font_size_medium color_white border_radius_secondary" type="submit" name="send">
      Send 
    </button>
  </form>
  ...
  <script defer src="https://cdn.jsdelivr.net/npm/rizalcss@1.5.0/js/rizal.min.js" integrity="sha256-HBuvk3PCFCXtzy/G/393UvcosSWVy6WHf5sRnZdzmio=" crossorigin="anonymous"></script>
      ...
      <style>
        body {
            background-image: url('https://sgp1.vultrobjects.com/img-in-th/UgmA8S.png');
